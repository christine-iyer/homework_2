...
let bodySelectImage = document.querySelector('body')
...
//      bodySelectImage.style.backgroundImage("#select-image")
...
const barbie = {
 ...
 const biscuit = new Clothing('Birkin Bag', 'Hermes', 'purple', 'bag', 'lg', 15470 )
...
const rentalButton = document.getElementById('rental');
 ...
 const biscuitButton = document.getElementById('biscuit');
 
 biscuitButton.addEventListener('click', ()=>{
     if(barbie.wallet >= biscuit.price){
         barbie.wardrobe.push(biscuit);
         barbie.wallet -= biscuit.price;
         barbie.render();
